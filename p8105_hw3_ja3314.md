...
|  year|  mean(prop\_excellent)|  sd(prop\_excellent)|
|-----:|----------------------:|--------------------:|
...
The `instacart` dataset is a tibble data frame with dimensions 1384617 rows and 15 columns. This data is taken from the instacart shopping app It contains information on specific products -- such as their names and what aisle they are located on -- as well as information about the individual orders themselves. Each product is associated with an aisle number which corresponds to an aisle name and department number; for example, "organic half & half" is found in aisle \#53 - cream in department 16.
...
The `NY NOAA` dataset is a tibble data frame with dimensions 2595176 rows and 7 columns. It contains data from the National Oceanic and Atmospheric Association on the weather observed at New York weather stations. It contains variables such as precipitation and maximum/minimum temperatures. There is missing data and there are unusual units however this can be dealt with in data cleaning.
...
![](p8105_hw3_ja3314_files/figure-markdown_github/unnamed-chunk-12-1.png)
...
![](p8105_hw3_ja3314_files/figure-markdown_github/unnamed-chunk-13-1.png)
